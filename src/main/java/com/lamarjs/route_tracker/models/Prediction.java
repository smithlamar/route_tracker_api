...
public class Prediction {
	...
	/**
	 * @param tablockid the tablockid to set
	 */
	...
	/**
	 * @param tatripid the tatripid to set
	 */
	...
	/**
	 * @param prdctdn the prdctdn to set
	 */
